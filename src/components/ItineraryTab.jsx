...
export default function ItineraryTab({ tripId, items, setItems }) {
  ...
  return (
    <>
      <style>{`
        .itin-form-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 14px; }
        .itin-edit-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 10px; }
        .itin-item-actions { flex-direction: row; }
        @media (max-width: 480px) {
          .itin-form-grid { grid-template-columns: 1fr; }
          .itin-edit-grid { grid-template-columns: 1fr; }
          .itin-item { flex-direction: column; gap: 10px !important; }
          .itin-item-actions { flex-direction: row; margin-left: 0 !important; }
          .itin-time { min-width: unset !important; }
        }
      `}</style>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
        ...
        <div style={{
          ...
          <form onSubmit={handleAdd} style={{ padding: "20px 22px", display: "flex", flexDirection: "column", gap: 14 }}>
            ...
            <div>
              ...
              <input ref={activityInputRef} type="text" name="activity"
                value={form.activity} onChange={handleChange} required
                placeholder="e.g. Visit Baga Beach" style={{ ...inputStyle }}
                onFocus={e => e.target.style.borderColor = "rgba(99,102,241,0.5)"}
                onBlur={e => e.target.style.borderColor = "rgba(255,255,255,0.1)"}
              />
            </div>
            ...
            <div>
              ...
              <input type="text" name="place" value={form.place} onChange={handleChange}
                placeholder="e.g. Baga Beach, North Goa" style={{ ...inputStyle }}
                onFocus={e => e.target.style.borderColor = "rgba(99,102,241,0.5)"}
                onBlur={e => e.target.style.borderColor = "rgba(255,255,255,0.1)"}
              />
            </div>
            ...
            <div>
              ...
              <input type="text" name="note" value={form.note} onChange={handleChange}
                placeholder="e.g. Carry sunscreen" style={{ ...inputStyle }}
                onFocus={e => e.target.style.borderColor = "rgba(99,102,241,0.5)"}
                onBlur={e => e.target.style.borderColor = "rgba(255,255,255,0.1)"}
              />
            </div>
        ...
        {Object.keys(groupedItems).length === 0 ? (
          <div style={{
            ...
            background: "#1a1828", borderRadius: 16,
            border: "1px dashed rgba(255,255,255,0.08)", color: "#3d3b55"
          }}>
            ...
            <div key={day}>
              <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 10 }}>
                <span style={{
                  ...
                  letterSpacing: "0.06em", border: "1px solid rgba(99,102,241,0.2)",
                  whiteSpace: "nowrap"
                }}>{day}</span>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                {dayItems.sort((a, b) => a.time?.localeCompare(b.time)).map(item => (
                  <div key={item.id} style={{
                    background: "#1a1828", borderRadius: 12,
                      ...
                      <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                        ...
                        <div style={{ display: "flex", gap: 8, marginTop: 2 }}>
                          ...
                          <button onClick={() => setEditingId(null)} style={{
                            ...
                            fontSize: 12, color: "#9b98b8", cursor: "pointer"
                          }}>Cancel</button>
                        </div>
                      </div>
                    ) : (
                      <div className="itin-item" style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between" }}>
                        <div style={{ display: "flex", gap: 14 }}>
                          <span className="itin-time" style={{
                        ...
                        <div className="itin-item-actions" style={{ display: "flex", gap: 7, marginLeft: 12, flexShrink: 0 }}>
                          ...
                          <button onClick={() => handleDelete(item.id)} style={{
                            ...
                            borderRadius: 7, padding: "4px 12px",
                            fontSize: 12, fontWeight: 600, color: "#f87171", cursor: "pointer"
                          }}>Delete</button>
                        </div>
                      </div>
                    )}
