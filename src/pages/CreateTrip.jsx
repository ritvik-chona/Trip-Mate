...
export default function CreateTrip() {
  ...
  return (
    <>
      <style>{`
        .create-container { padding: 48px 24px; }
        .create-card-inner { padding: 28px 32px; }
        @media (max-width: 600px) {
          .create-container { padding: 24px 16px; }
          .create-card-inner { padding: 22px 20px; }
          .create-card { border-radius: 16px !important; }
        }
      `}</style>

      <div style={{ minHeight: "100vh", background: "#0f0e17" }}>
        <Navbar />
        <div className="create-container" style={{ maxWidth: 520, margin: "0 auto" }}>
          ...
          <div className="create-card" style={{
            ...
            <form onSubmit={handleSubmit} className="create-card-inner" style={{
